...
public class ConstraintsTestBoundedEdits {
	...
	static SFT<CharPred, CharFunc, Character> customConstraintsTest(Context ctx, SFA<CharPred, Character> source, 
			SFA<CharPred, Character> target, int numStates, int outputBound, int numEdits, 
		...
		ConstraintsBoundedEdits c = new ConstraintsBoundedEdits(ctx, source, targetTotal, alphabetMap, ba);
	...
	static void constraintsTest1(Context ctx) throws TimeoutException {
        ...
        SFT<CharPred, CharFunc, Character> synthSFT = customConstraintsTest(ctx, mySFA01, mySFA03, 1, 2, numEdits, examples, null, null, false);
	...
	static void constraintsTest2(Context ctx) throws TimeoutException {
        ...
        SFT<CharPred, CharFunc, Character> synthSFT = customConstraintsTest(ctx, mySFA07, mySFA08, 2, 2, numEdits, examples, null, null, false);
        System.out.println(synthSFT.toDotString(ba));
	}
